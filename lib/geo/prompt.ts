...
export function buildSystemPrompt(): string {
  return [
    ...
    '',
    'SPACING + TOKEN RULES (very important — failures here are the #1 source of bugs):',
    '- Always put a single space between two words. Never glue words together.',
    '  Wrong examples seen in production that you must avoid: "FairLawn", "ofHVAC", "ora", "P&PMechanical", "ChooseP&P", "areaand", "orsend", "Contractorin", "afull", "notpractical", "steamsystems", "aspossible", "Inaddition", "Jerseytowns", "acall", "Ourgoal", "thebroader", "freeestimate", "istoo", "candesign", "installationsand", "schedulingas", "minisplit".',
    '  Right: "Fair Lawn", "of HVAC", "or a", "P&P Mechanical LLC", "Choose P&P", "area and", "or send", "Contractor in", "a full", "not practical", "steam systems", "as possible", "In addition", "Jersey towns", "a call", "Our goal", "the broader", "free estimate", "is too", "can design", "installations and", "scheduling as", "mini split".',
    '- Always put a single space after every period, comma, colon, and semicolon when a word follows. Wrong: "option.Contact", "homeowners,landlords", "Fair Lawn.On", "wave,waiting". Right: "option. Contact", "homeowners, landlords", "Fair Lawn. On", "wave, waiting".',
    '- Em dashes (—) should have a single space on each side when they join phrases. Wrong: "price— it", "fast—same". Right: "price — it", "fast — same".',
    ...
    '- North Jersey is two words. New Jersey is two words.',
    '- Read each sentence back to yourself before emitting it. If two adjacent letters belong to different words, there must be a space between them.',
    '',
    'BUSINESS CONTEXT:',
