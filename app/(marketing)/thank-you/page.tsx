...
import { CheckCircle2, Phone, Clock, ArrowRight, MessageSquare } from 'lucide-react';
...
export const metadata: Metadata = {
  title: 'Thank You',
  description:
    'Your request has been received. A P&P Mechanical team member will reach out shortly.',
    ...
    <section className="py-24 sm:py-32">
      <div className="container-tight text-center">
        ...
        <p className="mx-auto mt-5 max-w-xl text-lg text-steel-100">
          A P&amp;P Mechanical team member will reach out within{' '}
          <strong className="text-white">2 hours</strong> during business hours, or first thing in
          the morning if you submitted overnight.
        </p>
        ...
        <div className="mx-auto mt-10 grid max-w-2xl gap-4 sm:grid-cols-2">
          <div className="rounded-xl border border-white/10 bg-white/[0.03] p-6 text-left">
            ...
            <p className="mt-1 text-sm text-steel-200">
              A real person calls — not a robot. We confirm details, schedule the visit, and (if
              relevant) text you a tech ETA.
            </p>
          </div>
        ...
        <div className="mx-auto mt-10 max-w-xl">
          <p className="text-sm text-steel-200">Need to reach us faster? Text or call directly:</p>
          <div className="mt-4 flex flex-col justify-center gap-3 sm:flex-row">
            ...
            <Button asChild size="lg" variant="primary">
              <a
                href={`sms:${BUSINESS.phoneHref.replace('tel:', '')}?&body=${encodeURIComponent(
